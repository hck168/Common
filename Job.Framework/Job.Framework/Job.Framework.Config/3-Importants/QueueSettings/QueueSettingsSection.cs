...
namespace Job.Framework.Config
{
    ...
    /// 表示配置文件中组节点
    /// </summary>
    public class QueueSettingsSection : AppConfigSection
    {
        /// <summary>
        /// 获取默认名称
        /// </summary>
        ...
        public AppConfigElementCollection<QueueSettingsElement> QueueSettings
        {
            get
            {
                return this[""] as AppConfigElementCollection<QueueSettingsElement>;
            }
            set
            {
                this[""] = value;
