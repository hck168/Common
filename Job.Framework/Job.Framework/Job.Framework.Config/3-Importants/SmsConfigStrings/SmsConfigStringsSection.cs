...
namespace Job.Framework.Config
{
    ...
    /// 表示配置文件中组节点
    /// </summary>
    public class SmsConfigStringsSection : AppConfigSection
    {
        /// <summary>
        /// 获取默认名称
        /// </summary>
        ...
        public AppConfigElementCollection<SmsConfigStringsElement> SmsConfigStrings
        {
            get
            {
                return this[""] as AppConfigElementCollection<SmsConfigStringsElement>;
            }
            set
            {
                this[""] = value;
