...
namespace Job.Framework.Config
{
    ...
    /// 表示配置文件中组节点
    /// </summary>
    public class EmailConfigStringsSection : AppConfigSection
    {
        /// <summary>
        /// 获取默认名称
        /// </summary>
        ...
        public AppConfigElementCollection<EmailConfigStringsElement> EmailConfigStrings
        {
            get
            {
                return this[""] as AppConfigElementCollection<EmailConfigStringsElement>;
            }
            set
            {
                this[""] = value;
